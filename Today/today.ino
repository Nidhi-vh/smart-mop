...
void goLeft() {
  motorControlFront(ENA, IN_2, IN_1, speedCar);
  motorControlBack(ENB, IN_3, IN_4, speedCar); // Increase speed for turning
}

void goRight() {
  motorControlBack(ENA, IN_2, IN_1, 400); // Increase speed for turning
  motorControlFront(ENB, IN_3, IN_4, 800);
}
